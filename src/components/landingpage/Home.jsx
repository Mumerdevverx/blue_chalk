...
const Home = () => {
  ...
  // Images now contain both URL and workSlug
      ...
      try {
        ...
        if (data.success && data.data.length > 0) {
          ...
          if (imageItems.length > 0) {
            // Keep both image URL and work slug
        ...
        // Fallback images already available
      } finally {
        setLoading(false);
      }
    };
            ...
            <>
              ...
              <div className="absolute right-4 top-4 z-50 w-[220px] bg-white px-7 py-6 shadow-xl lg:hidden">
                ...
                <div className="mb-7 flex items-center justify-between border-b border-gray-200 pb-4">
                  ...
                  <span className="text-[18px] font-medium text-[#07354a]">
                    Menu
                  </span>
            ...
            {images.map((image, index) => {
              ...
              const imageContent = (
                <img
                  ...
                  onError={(e) => {
                    e.target.src =
                      "https://placehold.co/600x400/e0e0e0/808080?text=No+Image";
                  }}
                />
              );
