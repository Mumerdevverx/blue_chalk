...
const Contact = () => {
  ...
  <div className="w-full">
    <div className="h-[300px] sm:h-[400px] md:h-[450px] bg-gray-200 relative overflow-hidden">
      ...
      {/* Color Overlay */}
      <div className="absolute inset-0 pointer-events-none transition-colors duration-700 bg-[#aeaeae] hover:bg-[#04a3f2] mix-blend-multiply"></div>
    </div>
    
    {/* Brooklyn Address - Below Map on Mobile, Side by Side on Desktop */}
    <div className="px-4 sm:px-6 lg:px-28  py-6 md:py-8 lg:py-10">
      <h2 className="text-base sm:text-lg lg:text-xl font-semibold text-gray-500 mb-2">
        Blue Chalk Brooklyn
      </h2>
  ...
  <div className="w-full">
    <div className="h-[300px] sm:h-[400px] md:h-[450px] bg-gray-300 relative overflow-hidden">
      ...
      {/* Color Overlay */}
      <div className="absolute inset-0 pointer-events-none transition-colors duration-700 bg-[#aeaeae] hover:bg-[#1893D2] mix-blend-multiply"></div>
    </div>
    ...
    <div className="px-4 sm:px-6 lg:px-8 xl:px-12 py-6 md:py-8 lg:py-10">
      ...
      <div className="bg-[#F5F4F2] border-t border-gray-200 py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-28">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-start gap-8 lg:gap-12">
          ...
          <div className="lg:w-1/3 xl:w-1/4 w-full">
            ...
            <p className="text-base sm:text-lg lg:text-[20px] leading-relaxed lg:leading-9 text-[#8d8d8d]">
          ...
          {/* Right Form */}
          <div className="lg:w-2/3 xl:w-3/4 w-full mt-6 lg:mt-0">
            <form>
              ...
              <div className="block md:hidden flex flex-col border border-[#e8e8e8] bg-white">
                ...
                <div className="grid grid-cols-2 border-b border-[#e8e8e8]">
                  <input
                    type="text"
                    placeholder="Name*"
                    className="w-full h-[44px] px-4 sm:px-5 outline-none text-sm sm:text-base border-r border-[#e8e8e8]"
                  />
                  <input
                    type="email"
                    placeholder="Email*"
                    className="w-full h-[44px] px-4 sm:px-5 outline-none text-sm sm:text-base"
                  />
                </div>
                ...
                <button
                  type="submit"
                  className="bg-[#1f93d1] text-white uppercase font-semibold hover:bg-[#167bb0] transition h-[52px] w-full text-sm sm:text-base"
                >
                  Subscribe
                </button>
              </div>
              ...
              <div className="hidden md:grid md:grid-cols-[1fr_1fr_auto] border border-[#e8e8e8] bg-white lg:mt-12">
                ...
                <div className="border-b md:border-b-0 md:border-r border-[#e8e8e8]">
                  <input
                    type="text"
                    placeholder="Name*"
                    className="w-full h-[44px] px-5 outline-none text-sm sm:text-base"
                  />
                ...
                <button
                  type="submit"
                  className="bg-[#1f93d1] text-white uppercase font-semibold hover:bg-[#167bb0] transition h-[90px] w-full md:w-[240px] px-6 sm:px-8 text-sm sm:text-base"
                >
                  Subscribe
                </button>
              </div>
