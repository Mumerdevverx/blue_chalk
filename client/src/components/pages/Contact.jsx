    ...
    <>
      ...
      <div className="flex flex-col md:grid md:grid-cols-2">
        ...
        <div className="w-full">
          <div className="h-[300px] sm:h-[400px] md:h-[450px] bg-gray-200">
        ...
        <div className="w-full">
          <div className="h-[300px] sm:h-[400px] md:h-[450px] bg-gray-300">
            <div className="map-wrapper w-full h-full grayscale hover:grayscale-0 transition-all duration-700">
              <iframe
      ...
      <div className="bg-[#F5F4F2] border-t border-gray-200 py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8">
