  ...
  return (
    <div className="min-h-screen bg-white font-basis-web font-['Helvetica_Neue',Arial,sans-serif] relative overflow-x-hidden">
      ...
      >
        ...
        <div 
          ref={drawerRef}
          className={`drawer-content absolute right-0 top-0 h-full w-64 bg-white shadow-2xl transform transition-transform duration-300 ${
          ...
          >
            ...
            >
              {galleryImages.map((image) => (
                <div key={image.id} className="relative min-w-full h-full shrink-0 overflow-hidden">
                  <img
                    src={image.src}
                    alt={image.alt}
